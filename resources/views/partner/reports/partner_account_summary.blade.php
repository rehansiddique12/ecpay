...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
            <div class="card-body">
                <h3 style="color: #7367f0">{{ __('partner_basic.Partner_Account_Summary_en')}}</h3>
                    ...
                    <table class="categories-show-table table table-hover table-striped table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col">@lang('partner_basic.Total_Receive_en')</th>
                                <th scope="col">@lang('partner_basic.Total_Withdrawal_en')</th>
                                <th scope="col">@lang('partner_basic.Total_Charges_en')</th>
                                <th scope="col">@lang('partner_basic.Daily_Balance_en')</th>
