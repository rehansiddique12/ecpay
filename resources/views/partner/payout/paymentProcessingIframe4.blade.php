        ...
        <div id="intime">
            ...
            <div class="" style="max-width:400px;margin:auto;display: none;" id="attemptfailed">
                <div class="text-center">
                    ...
                    <div style="display: flex; align-items: center;padding:20px 40px">
                        <div style="margin-right: 10px;">
                            <img class="img-fluid" src="{{ asset('assets/images/close.png') }}" style="width:100px;" />
                        </div>
                        <div style="text-align:right;width:100%">
...
service for assistance.
        ...
        <div style="max-width:400px;display:none;margin:auto" id="complete_div">
            <center>
                <img class="img-fluid" src="{{ asset('assets/images/check.png') }}" style="width:200px;" />
            </center>
        ...
        <div class="input-container" style="position: relative;">
            <input type="text" name="txn" class="form-control" id="txn_verification"
                ...
                data-min="{{($ewallet == 'bkash') ? 10 : (($ewallet == 'nagad') ? 8 : 25)}}"
        ...
        {{-- <div class="textanimation pt-2"><span style="font-weight: bold">Important Notice:</span><br> <span style="font-weight: bold;color:red">Please make sure the Transaction ID is correct before submitting.</span></div> --}}
            ...
            <input type="hidden" name="ewallet" value="{{ $ewallet }}">
