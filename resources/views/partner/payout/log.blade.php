...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card secbg form-block p-0 br-4">
            <div class="card-body">
                <form action="{{ route('partner.payout.history.search') }}" method="get">
                        ...
                        <div class="col-md-3">
                            <div class="form-group input-box mb-2">
                                <select name="status" class="form-control">
                                    ...
                                    <option value="1" @if(@request()->status == '1') selected @endif>@lang('Pending Payment')</option>
                                    <option value="2" @if(@request()->status == '2') selected @endif>@lang('Complete Payment')</option>
                                    <option value="3" @if(@request()->status == '3') selected @endif>@lang('Rejected Payment')</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped " id="service-table">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col">User Account No</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Detail')">
                                    <button type="button" class="action-btn infoButton " data-information="{{json_encode($item->information)}}" data-feedback="{{$item->feedback}}" data-trx_id="{{ $item->trx_id }}"><i class="fa fa-info-circle"></i></button>
                                </td>
                            </tr>
                            @empty
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content form-block">
            ...
            <div class="modal-body">
                <div class="payment-info">
                    <ul class="list-group ">
                        ...
                        <li class="list-group-item bg-transparent">@lang('Admin Feedback') : <span class="feedback"></span></li>
                    </ul>
                </div>
                <div class="payment-info">
            ...
            <div class="modal-footer">
                <button type="button" class=" btn btn-success mb-2 me-3 closeModal" data-bs-dismiss="modal">@lang('Close')</button>
            </div>
        </div>
    </div>
</div>
