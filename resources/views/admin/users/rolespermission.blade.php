            ...
            <div class="col-md-12">
                ...
                <div class="assign-permissions-content">
                    ...
                    <div class="row align-items-center mb-3 mt-4">
                        <h4 for="role_select" class="col-md-2">{{ __('userManagement.role') }}</h4>
                    ...
                    <div class="form-group col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between text-center">
                                <h5 class="card-title text-center">{{ __('userManagement.accessibility') }}</h5>
                            </div>
                            <form role="form" method="POST" class="actionRoute"
                                ...
                                <div class="card-body select-all-access">
                                    <div class="form-group">
                                        {{-- <label> --}}
                                        <input type="checkbox" class="selectAll custom-checkbox-lg mb-3"
                                            name="accessAll">
                                        <span class="custom-label-lg">{{ __('userManagement.select_all') }}</span>
                                        {{-- </label> --}}
                                    </div>
                                    ...
                                    <table class=" table table-hover table-striped table-bordered">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th>{{ __('userManagement.permissions') }}</th>
                                                <th class="text-center">{{ __('userManagement.view') }}</th>
                                                <th class="text-center">{{ __('userManagement.add') }}</th>
                                                <th class="text-center">{{ __('userManagement.edit') }}</th>
                                                <th class="text-center">{{ __('userManagement.delete') }}</th>
                                            </tr>
                                        </thead>
                                                    ...
                                                    <td data-label="View">
                                                        @if (!empty($value['access']['view']))
                                                            <input type="checkbox" class="custom-checkbox"
                                                                ...
                                                                name="access[]"
                                                                @if (in_array_any($value['access']['view'], $storedPermissions ?? [])) checked @endif />
                                                        @endif
                                                    </td>
                                                    <td data-label="Add">
                                                        @if (!empty($value['access']['add']))
                                                            <input type="checkbox" class="custom-checkbox"
                                                                ...
                                                                name="access[]"
                                                                @if (in_array_any($value['access']['add'], $storedPermissions ?? [])) checked @endif />
                                                        @endif
                                                    </td>
                                                    <td data-label="Edit">
                                                        @if (!empty($value['access']['edit']))
                                                            <input type="checkbox" class="custom-checkbox"
                                                                ...
                                                                name="access[]"
                                                                @if (in_array_any($value['access']['edit'], $storedPermissions ?? [])) checked @endif />
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td data-label="Delete">
                                                        @if (!empty($value['access']['delete']))
                                                            <input type="checkbox" class="custom-checkbox"
                                                                ...
                                                                name="access[]"
                                                                @if (in_array_any($value['access']['delete'], $storedPermissions ?? [])) checked @endif />
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12 text-end">
                                        <button type="submit" class="btn btn-primary me-2" id="updatePermissions">
                                            <i class="fas fa-save"></i> {{ __('userManagement.update_permissions') }}
                                        </button>
