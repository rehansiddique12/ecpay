                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="location" id="filterLocation">
                                ...
                                <option value="{{ $key }}" @if (@request()->location == $key) selected @endif>
                                    {{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="role_type" id="filterRole">
                                ...
                                <option value="{{ $role }}" @if (@request()->roles == $role) selected @endif>
                                    {{ $role }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <table id="staffTable" class="table table-sm">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th style="width: 200px;">@lang('User')</th>
                            <th style="width: 150px;">@lang('Location')</th>
                            <th style="width: 150px;">@lang('Roles')</th>
        ...
        <div class="modal-dialog modal-lg">
            <form id="storeStaffForm" role="form" method="POST" class="modal-content"
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTopTitle">@lang('Add New Admin')</h5>
