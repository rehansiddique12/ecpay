                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-lg-center text-right">
                                        <form class="toggle-status-form d-inline" data-id="{{ $item->id }}" data-url="{{ route('admin.groups.toggleStatus', $item->id) }}">
                                            @csrf
                                            <button type="button" class="btn btn-sm toggle-status-btn {{ $item->status ? 'btn-success' : 'btn-danger' }}">
                                                <i class="fa fa-circle me-1"></i> {{ $item->status ? __('Active') : __('Inactive') }}
                                            </button>
                                        </form>
                                    </td>
