...
<div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
    <form action="{{ route('admin.reports.partner_account_balance_summary_completions') }}" method="get">
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    @if($item['current_balance']-$item['closing_balance']<1 && $item['current_balance']-$item['closing_balance']>-1)
                                        <td style="background-color: green;color:white">{{ number_format($item['current_balance'], 2) }}</td>

                                    @else
                                        <td style="background-color: red;color:white">{{ number_format($item['current_balance'], 2) }}</td>
                                    @endif
                                    @else
                                    <td></td>
                                    @endif
