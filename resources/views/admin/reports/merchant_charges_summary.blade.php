                ...
                <div class="col-md-3">
                    <div class="form-group mt-4">
                        <button type="submit" class="btn waves-effect waves-light btn-primary"
                            style="margin-top: 10px;"><i class="icon-base ti tabler-search me-1"></i>
                            {{ __('reports.search') }}</button>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <table class="categories-show-table table table-hover table-striped table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('reports.total_deposit_amount') }}</th>
                                    <th scope="col">{{ __('reports.total_deposit_charges') }}</th>
                                    <th scope="col">{{ __('reports.total_withdrawal_amount') }}</th>
