            ...
            <div class="">
                ...
                <table class="categories-show-table table table-hover table-striped table-bordered settable table-sm">
                    <thead class="thead-dark bg-primary">
                        <tr>
                            ...
                            <th scope="col">{{ __('accounts.category_name') }}</th>
                ...
                <div id="tableLoader" class="loading-overlay d-none">
                    <div class="spinner-border text-primary" role="status">
                        <span class="visually-hidden">{{ __('accounts.processing') }}</span>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="color: #7367f0" id="modalTopTitle">{{ __('accounts.add_new') }}
                    </h5>
                ...
                <form id="addCategoryForm" action="" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="pr-3">{{ __('accounts.category_name') }}</label>
                            <input type="text" class="form-control" name="name" required />
                            <span class="name_error text-danger error-text"></span>
                        </div>
                        <div class="form-group mt-3">
                            <label class="pr-3">{{ __('accounts.status') }}</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary modal-colored-header">
                    <h5 class="modal-title" style="color: white" id="modalTopTitle">{{ __('accounts.edit_record') }}
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
