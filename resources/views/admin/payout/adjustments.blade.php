                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-select">
                                ...
                                <option value="1" @if (@request()->status == '1') selected @endif>
                                    {{ __('partner.completed') }}</option>
                                <option value="0" @if (@request()->status == '0') selected @endif>
                                    {{ __('partner.pending') }}</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <table class="categories-show-table table table-hover table-striped table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('partner.payment_amount') }}</th>
                                    <th scope="col">{{ __('partner.withdrawal_amount') }}</th>
                                    <th scope="col">{{ __('partner.amount_adjusted') }}</th>
        ...
        <script>
            $(document).ready(function() {
                $('form').on('submit', function() {
                    ...
                    $submitButton.html(
                        "<i class='fa fa-spinner fa-spin me-1' > < /i> {{ __('partner.processing') }}");
