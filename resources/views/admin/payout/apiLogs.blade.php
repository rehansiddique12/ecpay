                ...
                <table class=" table table-sm  table-hover table-striped table-bordered text-white"
                    ...
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th style="width: 400px;">{{ __('partner.request_header') }}</th>
                            <th style="width: 100px;">{{ __('partner.response_code') }}</th>
                            <th style="width: 300px;">{{ __('partner.response_payload') }}</th>
                            <th style="width: 200px;">{{ __('partner.response_header') }}</th>
                    ...
                    <tbody>
                        @forelse($data as $transaction)
                            <tr>
                                ...
                                <td data-label="{{ __('partner.request_header') }}">
                                    {{ $transaction->request_headers }}
                                </td>

                                <td data-label="{{ __('partner.response_code') }}">{{ $transaction->response_code }}
                                </td>
                                ...
                                <td data-label="{{ __('partner.response_header') }}">
