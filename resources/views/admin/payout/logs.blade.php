<x-admin-layout :title="$pageTitle">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary"><i class="icon-base ti tabler-search me-1"></i> @lang('Search')</button>
                                <button type="submit" name="export" value="export" class="btn btn-success mt-2"><i class="icon-base ti tabler-download me-1"></i> @lang('Export Data')</button>
                    </div>
                </div>
    ...
    <audio id="notification-sound" src="{{asset(config('location.withdrawLog.path'))}}/dogru-128492.mp3" preload="auto"></audio>
            ...
            <form role="form" method="POST" action="{{ route('admin.payout.update_e_wallet') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="get-feedback">
                        ...
                        <button type="submit" class="btn btn-primary mt-3" name="status" value="1">@lang('Change')</button>
                    </div>
    ...
    <div class="modal modal-top fade" id="myModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form role="form" method="POST" class="actionRoute" id="actionRoutee" action="" enctype="multipart/form-data" onsubmit="submitForm(this)">
                    @csrf
                    @method('put')
                    <div class="modal-body">
                        <ul class="list-group withdraw-detail">
...
function setBalanceItem(itemId) {
    ...
    jQuery.ajax({
        ...
        error: function(xhr, status, error) {
            ...
            jQuery("#text1").text('An error occurred while processing your request. Please try again.');
            jQuery("#text2").text('');
            jQuery("#text3").text('');
        }
    });
        ...
        $(document).ready(function() {
            ...
            function fetchNotification() {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    data: { letest_record: letest_record },
                    success: function(response) {
