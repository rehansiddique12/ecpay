        ...
        <div class="col-md-12">
            <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
                <form action="{{ route('admin.accounts.charges.add') }}" method="post">
                    @csrf
                    <div class="">
                        <input type="text" hidden value="{{ $account_id }}" class="form-control" name="account_id"
                            required />
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ $free_transections_day }}" class="form-control"
                                        name="free_transections_day"/ required>
                                </div>
                            </div>
                        </div>
                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" readonly
                                                        value="{{ $commission->from_amount }}" class="form-control"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="{{ $commission->to_amount }}"
                                                        class="form-control" id="to_amount_{{ $key }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.01"
                                                            value="{{ $commission->charges }}" class="form-control"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="charges_type[]">
                                                        <option {{ $commission->charges_type == 1 ? 'selected' : '' }}
                                                            value="1">Amount</option>
                                                        <option {{ $commission->charges_type == 2 ? 'selected' : '' }}
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" value="{{ $commission->wcharges }}"
                                                            step="0.01" class="form-control" name="wcharges[]"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="wcharges_type[]">
                                                        <option {{ $commission->wcharges_type == 1 ? 'selected' : '' }}
                                                            value="1">Amount</option>
                                                        <option {{ $commission->wcharges_type == 1 ? 'selected' : '' }}
                                                            value="2">Percentage</option>
                                                    </select>
                                                ...
                                                @if ($key > 0)
                                                    <div class="row">
                                                        <div class='col-1' style='padding-left:13px;'>
                                                            <button type='button'
                                                                class='cancel-row btn btn-danger mt-1'
                            ...
                            <div style='border:1px solid;padding:20px'>
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="pr-3">To Amount</label>
                                            <input type="number" class="form-control" id="to_amount_0"
                                                name="to_amount[]"/ required>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                        ...
                        <div id="add-row" class="d-flex">
                            <div class="col-md-1 mb-5 mt-3">
                                <button type="button" class="duplicate-row btn btn-success add-more">Add
                                    More</button>
                            </div>
