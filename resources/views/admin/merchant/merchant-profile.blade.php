                                            ...
                                            @forelse ($MCommissions as $index => $pcom)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2 text-warning">
                                                        {{ $pcom->withdrawal_percentage }}%</div>
                                                </div>
                                            @empty
                                                <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-7 col-md-7">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="acc_type" class="form-control">
                                                        <option value="Partner"
                                                            {{ $data->acc_type == 'Partner' ? 'selected' : '' }}>
                                                            Partner
                                                        </option>
                                                        <option value="Agent"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="sign" class="form-control">
                                                        <option value="1"
                                                            {{ $data->sign == 1 ? 'selected' : '' }}>Yes
                                                        </option>
                                                        <option value="0"
                                                            {{ $data->sign == 0 ? 'selected' : '' }}>No
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="txn_verification" class="form-control">
                                                        <option value="1"
                                                            {{ $data->txn_verification == 1 ? 'selected' : '' }}>
                                                            Enabled
                                                        </option>
                                                        <option value="0"
                                ...
                                <div class="card card-action ">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @forelse ($partner_staff as $index => $user)
                                          
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td>{{ $user->name }}</td>
                                                    <td> <div class="col-12">
                                                        <button class="btn btn-primary" type="submit"><a style="color: #fff"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center">No matching staff found.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
