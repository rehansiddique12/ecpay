<x-admin-layout :title="$pageTitle">
    ...
    <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
        <form action="{{ route('admin.merchant_reports.by_date') }}" method="get">
            <h3 style="color: #7367f0">{{ $pageTitle }}</h3>
            <div class="row align-items-left">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{ __('merchant_reports.select_date') }}</label>
                ...
                <div class="col-md-3">
                    <div class="form-group mt-2">
                        ...
                        <a href="{{ route('admin.merchant_reports.export_by_date', ['from_date' => $from_date]) }}"
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
                <div class="card-body">
                    <h3><b>{{ __('merchant_reports.total_commission') }}</b> {{ number_format($totalCommissionAll, 2) }}
                    </h3>
    ...
    @push('js')
        <script>
            ...
            document.getElementById('datepicker').addEventListener('change', function() {
                ...
                exportButton.href = "{{ route('admin.merchant_reports.export_by_date', ['from_date' => '']) }}/" +
                    selectedDate;
            });
        </script>
    @endpush
