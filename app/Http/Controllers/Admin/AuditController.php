...
class AuditController extends Controller
{
    ...
    ->when($request->module, function ($q) use ($request) {
        ...
        $q->where(function ($subQ) use ($module) {
            ...
            } elseif ($module === 'API Balance Adjustment') {
                $subQ->where('module', 'like', '%API Balance Adjustment%');
            } elseif ($module === 'Transfer Balance') {
                $subQ->where('module', 'like', '%Transfer Balance%');
            }
        });
    })
