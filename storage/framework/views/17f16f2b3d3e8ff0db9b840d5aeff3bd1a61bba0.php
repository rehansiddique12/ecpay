...
<div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
    <form action="<?php echo e(route('partner.merchant_reports.by_name')); ?>" method="get">
        ...
        <div class="row align-items-left">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="merchant" class="form-select">
                        ...
                        <option value="<?php echo e($key); ?>" <?php if(@request()->merchant == $key): ?> selected <?php endif; ?>><?php echo e($val); ?></option>
            ...
            <div class="col-md-3">
                <div class="form-group mt-2">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo e(route('partner.merchant_reports.export_by_name', ['from_date' => $from_date , 'to_date' => $to_date , 'merchant' => @request()->merchant])); ?>"
...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
            <div class="card-body">
                <?php if(isset($totalSummary)): ?>
                <div>
                    <h4 class="text-bold">Summary</h4>
                    <table class="table table-bordered">
                        <tr>
                            <td>Total Deposit Transaction:</td>
                            <td><?php echo e(number_format($totalSummary->total_deposit_transactions , 0)); ?></td>
                            <td>Total Amount:</td>
                            <td><?php echo e(number_format($totalSummary->total_deposit , 2)); ?></td>
                            <td>Commission:</td>
                            <td><?php echo e(number_format($totalSummary->total_deposit_commission , 2)); ?></td>
                            <td>Total Commission:</td>
                            <td><?php echo e(number_format($totalSummary->total_commission , 2)); ?></td>
                        </tr>
                        <tr>
                            <td>Total Withdrawal Transaction:</td>
                            <td><?php echo e(number_format($totalSummary->total_withdrawal_transactions , 0)); ?></td>
                            <td>Total Amount:</td>
                            <td><?php echo e(number_format($totalSummary->total_withdrawal , 0)); ?></td>
                            <td>Commission:</td>
                            <td><?php echo e(number_format($totalSummary->total_withdrawal_commission , 0)); ?></td>
                            <td></td>
                            <td></td>
                        </tr>
                    </table>
                    ...
                    <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    <td>
                                        <?php if($previousMerchant !== $apis[$result->api_id]): ?>
                                        <?php echo e($apis[$result->api_id]); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/partner/merchant/report_by_name.blade.php ENDPATH**/ ?>