...
<div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
    <form action="<?php echo e(route('admin.reports.merchant_charges_summary.search')); ?>" method="get">
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="website" class="form-select select2" data-allow-clear="true" data-placeholder="Select Domain">
                        ...
                        <option value="<?php echo e($partner->website); ?>" <?php if(@request()->website == $partner->website): ?> selected <?php endif; ?>><?php echo e($partner->name); ?></option>
            ...
            <div class="col-md-3">
                <div class="form-group mt-4">
                    <button type="submit" class="btn waves-effect waves-light btn-primary" style="margin-top: 10px;"><i class="icon-base ti tabler-search me-1"></i> <?php echo app('translator')->get('Search'); ?></button>
                </div>
            </div>
        </div>
    </form>
        ...
        <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
            <div class="card-body">
                    ...
                    <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(number_format($item['total_charges'], 2)); ?></td>
                ...
                <div class="card-footer">
                    <?php echo e($domains->appends($_GET)->links('partials.pagination')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/reports/merchant_charges_summary.blade.php ENDPATH**/ ?>