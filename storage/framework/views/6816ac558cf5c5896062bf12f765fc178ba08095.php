...
<?php $component->withAttributes([]); ?>
    <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
        <form action="<?php echo e(route('admin.payment.report.daily.search')); ?>" method="get">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-striped table-bordered">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $paymentsByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'All'])); ?>';"> <?php echo e($payment->payment_date); ?></td>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'All'])); ?>';"> <?php echo e($payment->payment_count); ?></td>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'Pending'])); ?>';"> <?php echo e($payment->pending_count); ?></td>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'Pending'])); ?>';"> <?php echo e(getAmount($payment->pending_amount,2)); ?></td>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'Complete'])); ?>';"> <?php echo e($payment->complete_count); ?></td>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'Complete'])); ?>';"> <?php echo e(getAmount($payment->complete_amount,2)); ?></td>
                            <td onclick="window.location='<?php echo e(route('admin.payment.report.detail', ['date' => $payment->payment_date,'gateway' => $gateway,'status' => 'All'])); ?>';"> <?php echo e(getAmount($payment->total_amount,2)); ?></td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/payment/daily_report.blade.php ENDPATH**/ ?>