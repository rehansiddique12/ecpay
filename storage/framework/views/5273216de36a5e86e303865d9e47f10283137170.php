...
<?php $component->withAttributes([]); ?>
    <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
        <form action="<?php echo e(route('admin.payment.apisearch')); ?>" method="get">
                ...
                <div class="col-md-5">
                    <div class="form-group mb-2">
                        <select name="status" class="form-select">
                            <option value="" style="bg-primary" <?php if(@request()->status == ''): ?> selected <?php endif; ?>>
                                <?php echo app('translator')->get('All Payment'); ?></option>
                            <option value="Complete " <?php if(@request()->status == 'Complete'): ?> selected <?php endif; ?>>
                                <?php echo app('translator')->get('Complete Payment'); ?></option>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <select name="domain" class="form-select select2"
                            ...
                            <option></option <option value=""><?php echo app('translator')->get('Select Domain'); ?></option>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/payment/api_log.blade.php ENDPATH**/ ?>