...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('partner.merchant_reports.by_date')); ?>" method="get">
        ...
        <div class="row align-items-left">
            ...
            <div class="col-md-3">
                <div class="form-group mt-2">
                    ...
                    <a href="<?php echo e(route('partner.merchant_reports.export_by_date', ['from_date' => $from_date])); ?>"
...
<script>
    ...
    document.getElementById('datepicker').addEventListener('change', function() {
        ...
        exportButton.href = "<?php echo e(route('partner.merchant_reports.export_by_date', ['from_date' => ''])); ?>/" + selectedDate;
    });
</script>
<?php $__env->stopPush(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/partner/merchant/report_by_date.blade.php ENDPATH**/ ?>