...
<?php $component->withAttributes([]); ?>
        ...
        <div class="row justify-content-between">
            <div class="col-md-12">
                ...
                <div class="card card-primary my-4 shadow">
                    <div class="card-body">
                        <?php if(adminAccessRoute(config('role.roles_category.access.add'))): ?>
                            ...
                            <table id="rolesTables"
                                ...
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col"><?php echo app('translator')->get('Roles Name'); ?></th>
                                        <th class="text-center" scope="col"><?php echo app('translator')->get('Action'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <div class="modal fade" id="cloneModal" tabindex="-1" aria-labelledby="cloneModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="addRolesFormCopy" action="<?php echo e(route('admin.roles.copy')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            $('.categories-show-table').DataTable({
                    ...
                    stateSave: true,
                    ajax: {
                        url: "<?php echo e(route('admin.rolescategory')); ?>", // Make sure this route returns JSON for DataTable
                        type: 'GET',
                        beforeSend: function () {
        ...
        $('#cloneModal').on('show.bs.modal', function () {
            $.ajax({
                url: "<?php echo e(route('admin.roles.list')); ?>", // Create this route
                type: "GET",
                success: function(response) {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/users/user-roles.blade.php ENDPATH**/ ?>