            ...
            <div class="modal-dialog modal-lg">
                <form id="storeStaffForm" role="form" method="POST" class="modal-content"
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTopTitle"><?php echo app('translator')->get('Manage Admin Role'); ?></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="role_type" id="role_type" class="form-control " required>
                                    <?php $__currentLoopData = $list_roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      $(document).on('click', '.editAdminBtn', function () {
        ...
        $(document).ready(function () {
            ...
            $('#staffTable').DataTable({
                ...
                stateSave: true,
                ajax: {
                    url: "<?php echo e(route('admin.staff')); ?>",
                    type: 'GET',
                    beforeSend: function () {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/staff/index.blade.php ENDPATH**/ ?>