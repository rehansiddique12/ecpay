    ...
    <?php if(!empty($data)): ?>
        <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
            <div class="payment-container">
                ...
                <span id="timer" class="<?php echo e($time_class); ?>">00:00</span>
                <div class="p-2">
                    <img src="<?php echo e($logo); ?>" alt="Logo" class="header-logo">
                </div>
                <div class="p-0 m-0">
                    <img height="5" width="100%" src="<?php echo e($banner); ?>" alt="Logo">
                </div>

                <div class="row text-center">
                    <div class="col-4">
                        <img width="60px" src="<?php echo e(asset('assets/images/shopping-bag.png')); ?>"
                            alt="Logo">

                    </div>
                    <div class="col-8 p-0 m-0">
                        <p class="text-left text-bold" style="line-height: 1.2"><b><span style="font-size: 20px">Your payment amount is:</span><br> ৳
                               <span style="font-size: 30px"> <?php echo e(number_format($data['amount'], 2, '.', ',')); ?><span></b></p>
                    </div>
                </div>

                <div id="intime">

                <div class="row <?php echo e($background_image); ?> m-1 pb-2">
                    <div class="pt-3 col-md-4 <?php echo e($ewallet == 'rocket' ? 'text-black' : 'text-white'); ?>">
                        <span>
                            <?php if($data['account_type']=="Merchant" || $data['account_type']=="Personal"): ?>
                            Please send to: <br>
                            পাঠান দয়া করে:
                            <?php else: ?>
                    ...
                    <div class="col-md-8 mt-4">
                          <div class="text-white input-container">
                            <input type="text" style="background-color:white" id="accountNumber" readonly value="<?php echo e($data['phone_number']); ?>" class="form-control">
                            <button id="copyButton"
                                class="<?php echo e($button_style); ?> btn-sm <?php echo e($ewallet == 'nagad' ? 'text-black' : ''); ?>">Copy |
                                অনুলিপি</button>
                        </div>
                        <div class="<?php echo e($ewallet == 'rocket' ? 'text-black' : 'text-white'); ?>" style="margin-top:">Account Type: <b><?php echo e($data['account_type']); ?></b></div>
                    </div>
                </div>
                ...
                <div class="row text-center mt-2 p-2">
                  ...
                  <?php if($ewallet == "bkash"): ?>
                    <div class="row pl-3 pr-3 d-flex justify-content-center">
                        <img src="<?php echo e($imgName[$data['account_type']]); ?>" class="img-fluid img-custom" alt="Responsive Image">
                    </div>
                <?php endif; ?>
                ...
                <div class=" col-md-5 text-center mx-auto">
                    <a href="<?php echo e(route('iframe.payment', ['id' => $data['id'],'txn'=>'','time'=>time()])); ?>" class="<?php echo e($button_style); ?>" id="complete-button">SUBMIT |
                        সম্পূর্ণ</a>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/partner/payout/process_transection.blade.php ENDPATH**/ ?>