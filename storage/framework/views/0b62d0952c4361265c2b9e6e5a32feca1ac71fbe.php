                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="max-width: 110px;"><a
                                            href="<?php echo e(route('admin.agent.profile', $item->id)); ?>"><?php echo e($item['name']); ?></a>
                                    </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTopTitle"><?php echo app('translator')->get('Add Agent'); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?php echo e(route('admin.agent.add')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\subecpaypast\resources\views/admin/payout/agent.blade.php ENDPATH**/ ?>