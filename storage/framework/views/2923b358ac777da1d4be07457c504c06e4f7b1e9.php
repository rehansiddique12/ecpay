...
<div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
    <form action="<?php echo e(route('admin.merchant_reports.by_name')); ?>" method="get">
        ...
        <div class="row align-items-left">
            ...
            <div class="col-md-3">
                <div class="form-group mt-2">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo e(route('admin.merchant_reports.export_by_name', ['from_date' => $from_date])); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/merchant/report_by_name.blade.php ENDPATH**/ ?>