    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
                ...
                <form action="<?php echo e(route('admin.edit.partner.commission')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="cid" value="<?php echo e($cid); ?>">
                    <input type="hidden" name="user_id" value="<?php echo e($user_id); ?>">
                    <input type="hidden" name="partner_id" value="<?php echo e($parent_id); ?>">
                    <div class="mb-3">
                        <label for="partner_id" class="form-label">Parent</label>
                        <input type="text" readonly class="form-control" name="partner_id" value="<?php echo e($partner->name); ?>">
                    </div>
                        ...
                        <div style="border:1px solid;padding:20px">
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-4">
                                    ...
                                    <input style="border:2px solid green;" type="number" name="deposit_percentage" value="<?php echo e($ParentCommission->deposit_percentage); ?>" id="deposit" class="form-control" step="0.01"
                                        placeholder="Enter deposit percentage">
                                </div>
                                <div class="col-md-6 mt-4">
                                    <label for="withdrawal" class="form-label">Withdrawal Percentage</label>
                                    <input style="border:2px solid green;" type="number" name="withdrawal_percentage" value="<?php echo e($ParentCommission->withdrawal_percentage); ?>" id="withdrawal" class="form-control" step="0.01"
...
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/payout/partner_commission_edit.blade.php ENDPATH**/ ?>