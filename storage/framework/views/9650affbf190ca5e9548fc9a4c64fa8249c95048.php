            ...
            <div class="col-md-4">
                <div class="form-group">
                   ...
                   <select name="parent" class="form-select select2" data-allow-clear="true" data-placeholder="Select Parent">
                        ...
                        <option value="" <?php if(request()->parent === ''): ?> selected <?php endif; ?>>All</option>
                        <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($partner->id); ?>" <?php if(request()->parent == $partner->id): echo 'selected'; endif; ?>><?php echo e($partner->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\subecpaypast\resources\views/admin/payout/commission_report.blade.php ENDPATH**/ ?>