...
<div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
    <form action="<?php echo e(route('partner.reports.logs')); ?>" method="get">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-4">
                <div class="form-group mt-2">
                    ...
                    <a href="<?php echo e(route('partner.report.export_excel_record', ['from_date' => $from_date, 'to_date' => $to_date , 'order' => request('order') === 'asc' ? 'asc' : 'desc'])); ?>" class="btn waves-effect waves-light btn-success">
                    ...
                    <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item['txn_updated_at']); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/partner/reports/logs.blade.php ENDPATH**/ ?>