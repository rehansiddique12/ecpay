                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="location" id="filterLocation">
                                ...
                                <option value="<?php echo e($key); ?>" <?php if(@request()->location == $key): ?> selected <?php endif; ?>>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="role_type" id="filterRole">
                                ...
                                <option value="<?php echo e($role); ?>" <?php if(@request()->roles == $role): ?> selected <?php endif; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-select" id="filterStatus">
                                ...
                                <option value="1" <?php if(@request()->status == '1'): ?> selected <?php endif; ?>>
                                    <?php echo app('translator')->get('ON'); ?></option>
                                <option value="0" <?php if(@request()->status == '0'): ?> selected <?php endif; ?>>
                                    <?php echo app('translator')->get('OFF'); ?></option>
                            </select>
                        </div>
                    </div>
                ...
                <table id="staffTable" class="table table-sm">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th style="width: 200px;"><?php echo app('translator')->get('User'); ?></th>
                            <th style="width: 150px;"><?php echo app('translator')->get('Location'); ?></th>
                            <th style="width: 150px;"><?php echo app('translator')->get('Roles'); ?></th>
                            <th style="width: 100px;"><?php echo app('translator')->get('Status'); ?></th>
                            <?php if(adminAccessRoute(config('role.manage_staff.access.edit'))): ?>
                            <th style="width: 100px;"><?php echo app('translator')->get('Action'); ?></th>
                            <?php endif; ?>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <div class="modal-dialog modal-lg">
            <form id="storeStaffForm" role="form" method="POST" class="modal-content"
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTopTitle"><?php echo app('translator')->get('Add New Admin'); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark"><?php echo e(trans('Name')); ?>:</label>
                            <input class="form-control" name="name" placeholder="<?php echo e(trans('Name')); ?>"
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark"><?php echo e(trans('Username')); ?>:</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark"><?php echo e(trans('Password')); ?>:</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark"><?php echo e(trans('Select Status')); ?>:</label>
                            <select name="status" id="event-status" class="form-select" required>
                                <option value="1" <?php if(old('status')=='1' ): ?> selected <?php endif; ?>><?php echo e(trans('Active')); ?>

                                </option>
                                <option value="0" <?php if(old('status')=='0' ): ?> selected <?php endif; ?>><?php echo e(trans('DeActive')); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="role_type" class="form-label">Select Role :</label>
            ...
            <form id="editForm" role="form" class="modal-content" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="edit_location" class="form-label">Select Location :</label>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/admin/users/list.blade.php ENDPATH**/ ?>