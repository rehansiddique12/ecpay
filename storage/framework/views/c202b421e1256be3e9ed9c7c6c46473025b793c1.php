...
<div class="page-header card card-primary m-0 m-md-4 my-4 m-md-0 p-5 shadow">
    <form action="<?php echo e(route('partner.merchant_reports.by_month')); ?>" method="get">
        ...
        <div class="row align-items-left">
            ...
            <div class="col-md-3">
                <div class="form-group mt-2">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo e(route('partner.merchant_reports.export_by_month', ['from_date' => $from_date ,'merchant' => @request()->merchant])); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecpay\resources\views/partner/merchant/report_by_month.blade.php ENDPATH**/ ?>