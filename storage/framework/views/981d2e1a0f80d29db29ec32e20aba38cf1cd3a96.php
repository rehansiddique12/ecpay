...
<html lang="en" class="layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-skin="default"
    data-assets-path="<?php echo e(asset('public/assets/')); ?>" data-template="horizontal-menu-template" data-bs-theme="dark">
                    ...
                    <div
                        ...
                        <div class="d-none d-lg-inline-block">
                            <a href="https://themeforest.net/licenses/standard" class="footer-link me-4"
                                target="_blank"><?php echo e(__('app.license')); ?></a>
                            <a href="https://themeforest.net/user/pixinvent/portfolio" target="_blank"
                                class="footer-link me-4"><?php echo e(__('app.more_themes')); ?></a>

                            <a href="https://demos.pixinvent.com/vuexy-html-admin-template/documentation/"
                                target="_blank" class="footer-link me-4"><?php echo e(__('app.documentation')); ?></a>

                            <a href="https://pixinvent.ticksy.com/" target="_blank"
                                class="footer-link d-none d-sm-inline-block"><?php echo e(__('app.support')); ?></a>
                        </div>
                    </div>
                </div>
            </footer>
